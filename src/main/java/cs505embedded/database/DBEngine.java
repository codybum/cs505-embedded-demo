...
public class DBEngine {
    ...
    public DBEngine() {
        ...
        try {
            ...
            if(Launcher.storage_mode == 0) {
                System.out.println("In-Memory DB");
                dbConnectionString = "jdbc:derby:memory:" + databaseName + ";create=true";
            } else {
                System.out.println("On-Disk DB");
                dbConnectionString = "jdbc:derby:./" + databaseName + ";create=true";
            }
            ds = setupDataSource(dbConnectionString);


            if(Paths.get(databaseName).toFile().exists()) {
                try {
    ...
    */
    ...
    public long getAvgts() {
        ...
        try {
            ...
            //fill in the query
            queryString = "SELECT * FROM accesslog";
            queryString = "SELECT AVG(access_ts) AS avg_ts FROM accesslog";
